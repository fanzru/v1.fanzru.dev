...
function Profile(props) {
  ...
  const markdown = {
    ...
    text_2: "I was born in **[Kebumen Regency, Central Java](https://goo.gl/maps/7kA1VVZNYESwvJUc8)** and until now I still live in Kebumen. I'm currently pursuing a bachelor's degree **Computer Science** at **Telkom University** and now I'm doing an internship at **PT. XL Axiata Tbk**.",
